    ...
    <div style={containerStyle}>
      ...
      <div style={windowStyle}>
        ...
        <div style={{ background: C.navy, padding: '18px 28px', borderBottom: `4px solid ${C.navy}`, textAlign: 'center' }}>
          <Pixel size={36} color={C.gold} style={{ display: 'block', letterSpacing: '0.05em' }}>
            HARMONY HUB
          </Pixel>
          <Mono style={{ fontSize: 12, color: C.cream, marginTop: 4, letterSpacing: '0.12em' }}>
            FAMILY MANAGEMENT SYSTEM v2.0
          </Mono>
          <Mono style={{ fontSize: 11, color: C.green, marginTop: 8 }}>
          ...
          {mode === 'choose' && (
            <>
              <div style={{ textAlign: 'center' }}>
                ...
                <Mono style={{ fontSize: 13, color: '#666', marginTop: 6 }}>
            ...
            <form onSubmit={handleEmailLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {error && (
                <div style={{ background: C.red, border: `2px solid ${C.navy}`, padding: '8px 12px' }}>
                  <Mono style={{ fontSize: 14, color: '#fff' }}>{error}</Mono>
                </div>
              )}
              ...
              <div style={{ textAlign: 'center' }}>
                <Mono style={{ fontSize: 13, color: '#666' }}>
                  ...
                  <span
                    ...
                    style={{ color: C.navy, cursor: 'pointer', textDecoration: 'underline' }}
                  >
                    LOG IN
                  </span>
                </Mono>
